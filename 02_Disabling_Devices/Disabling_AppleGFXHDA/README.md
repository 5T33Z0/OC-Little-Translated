...
## Adjusting the SSDT
- Open `SSDT-RADEON_GFX0-disable.aml`. You may have to adjust the `External` reference and `Scope` entries:</br>![](/Users/5t33z0/Desktop/RDNpci.png)
...
- Adjust the path and name accordingly:</br>![](/Users/5t33z0/Desktop/Adjust.png)
