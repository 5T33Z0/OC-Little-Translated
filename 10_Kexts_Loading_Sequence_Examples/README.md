...
3. Save and reboot
4. Verify that all the kext listed above are loaded. Enter `kextstat` in Terminal and check the list. If they are not loaded, add `-brcmfxbeta` boot-arg to your config. Save, reboot and verify again.
