...
- List all the SSDTs which should be included in the new SSDT (select all the.aml files in Finder, Copy and Paste them into the editor to bring in the file names):</br>![xiasl04](https://user-images.githubusercontent.com/76865553/176115532-81d5fe93-70b7-485d-9b8e-d6bfb7b91d96.png)
