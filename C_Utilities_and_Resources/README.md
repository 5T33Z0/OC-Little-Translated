...
- [**Catone**](https://github.com/dreamwhite/Catone) – Python script to remove sensitive data from the config.plist as well as restoring some default settings. Useful when preparing an EFI folder to be shared online.
