...
:-------------:| ------ | ------------
**`ACPI/Add`** | Add [**SSDT-CPBG.aml**](https://github.com/dortania/OpenCore-Legacy-Patcher/blob/main/payloads/ACPI/SSDT-CPBG.aml) | Patches `CPBG` for Arrandale, Lynnfield and Clarkdale. If your system doesn't have this device you probably don't need this.
