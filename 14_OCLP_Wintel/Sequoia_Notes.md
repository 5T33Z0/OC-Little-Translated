...
## OCLP Update Status
- **September 2nd, 2024**: New nightly build of OpenCore Legacy Patcher based on Sequoia Development branch is [avaialble here](https://github.com/dortania/OpenCore-Legacy-Patcher/pull/1137#issuecomment-2295376562) which can re-enable Ivy Bridge iGPUs and NVDIA Kepler Cards
