...
- Re-check your Pin-Config, the PathMap inside Platforms.xml, Layout.xmö adjust them, re-compile the kext, replace it in the EFI, reboot, test, repeat.
