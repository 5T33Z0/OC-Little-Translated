...
- [Creating a Virtual Machine (VM) for macOS](#creating-a-virtual-machine-vm-for-macos)
- [Preparing the macOS VM](#preparing-the-macos-vm)
- [Testing the VM](#testing-the-vm)
- [Links](#links)

---
## About
Guide for running macOS as a Virtual Machhine in Windows Hyper-V.
