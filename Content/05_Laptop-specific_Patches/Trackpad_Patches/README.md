...
- Depending on the Touchpad model (vendor and used protocol), you need additional [**Satellite kexts**](https://voodooi2c.github.io/#Satellite%20Kexts/Satellite%20Kexts):
	...
	|ELAN Proprietary|**VoodooI2CElan**</br>(included in VoodooI2C)|<ul><li>Implements support for the Elan protocol for Elan Touchpads and Touchscreens. Your Elan device may have better support with this kext than with **VoodooI2CHID**.<li>:warning: Some Elan devices (such as ELAN1200+) use the newer Precision Touchpad (PTP) which proprietary. As such, those devices will not work with **VoodooI2CElan**, so you have to use  **VoodooI2CHID** instead. <li> Some ELAN Touchpads require polling to work. Force-enable it by adding `force-polling` to the DeviceProperties of the Touchpad or by adding the boot-arg `-vi2c-force-polling`.|
...
- [**Larger version**](/Content/05_Laptop-specific_Patches/Trackpad_Patches/I2C_Workflow.jpg) (top down view)
