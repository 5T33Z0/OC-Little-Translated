...
This is my clumsy approach to calculate the correct values for the following bitmasks, using an Apple Numbers [Spreadsheet](/Content/B_OC_Calculators/OpenCoreCalcs.numbers):

Bitmask | Description
------|-----------
[`csr-active-config`](/Content/B_OC_Calculators/SIP_Flags_Explained.md) | Bitmask to configure (or disable) System Integrity Protection
