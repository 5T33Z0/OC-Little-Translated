...
A curated collection of guides, fixes, tools, and articles. Feel free to submit additions.

## 🧠 Apple Silicon & Architecture

* [Apple Silicon Guide](https://github.com/mikeroyal/Apple-Silicon-Guide)
* [Apple M1 CPU Microarchitecture (Firestorm)](https://dougallj.github.io/applecpu/firestorm.html)
* [Virtualizing OpenCore and x86 macOS on Apple Silicon](https://khronokernel.github.io/apple/silicon/2021/01/17/QEMU-AS.html)

## 🛠️ Hackintosh Guides & Tools

* [Nucintosh (Intel NUC Hackintosh Guide)](https://github.com/zearp/Nucintosh)
* [Old Hackintosh Guides (Rampage Dev Archive)](https://web.archive.org/web/20170911113616/http://www.rampagedev.com/guides/)
* [Why you shouldn't use tonymacX86 tools](https://github.com/khronokernel/Tonymacx86-stance)
* [BIOS Extraction and Modification Guide (CFG Lock)](https://github.com/dreamwhite/bios-extraction-guide/blob/master/README.md#unlock-cfg-lock)

## ⚙️ System Tweaks & Fixes
